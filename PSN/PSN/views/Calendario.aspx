<%@ Page Title="" Language="C#" MasterPageFile="~/views/PrincipalMaster.Master" AutoEventWireup="true" CodeBehind="Calendario.aspx.cs" Inherits="PSN.views.Calendario" %>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Calendário <small>Click para add/editar agendamentos</small></h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Calendário Angendamentos <small>Atividades</small></h2>
    ...
    <script>
      $(window).load(function() {
        ...
        var calendar = $('#calendar').fullCalendar({
          ...
          editable: true,
          events: [{
            title: 'Disciplina Projeto1',
            description: 'Inicio das atividades da disciplina projeto 1',
            start: new Date(2017, 1, 11,16),
            end: new Date(2017, 5, 8,23,59)
          }, {
            title: 'Apresentação Projeto1',
            start: new Date(2017, 5, 9, 18, 30),
            end: new Date(2017, 5, 9, 22),
            allDay: false
          }]
        });
      });
